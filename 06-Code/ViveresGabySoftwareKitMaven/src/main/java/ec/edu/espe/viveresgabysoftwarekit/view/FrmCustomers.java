...
public class FrmCustomers extends javax.swing.JFrame {
    ...
    public void aforeTable() {
        ...
        for (Customer customer : customerHandler.getCustomers()) {
            Object[] row = {customer.getId(), customer.getFullname(), customer.getEmail(), customer.getAddress(), customer.getPhone()};
            model.addRow(row);
        }
