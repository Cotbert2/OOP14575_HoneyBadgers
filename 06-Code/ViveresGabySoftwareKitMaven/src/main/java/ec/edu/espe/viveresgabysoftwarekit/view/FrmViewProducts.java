...
import ec.edu.espe.viveresgabysoftwarekit.controller.ProductHandler;
...
public class FrmViewProducts extends javax.swing.JFrame {
    ...
    public void aforeTable() {
        ProductHandler productController = new ProductHandler();
        ...
        for (Product product : productController.getProductList()) {
            Object [] row = {product.getName(), product.getCost(), product.getPvp(), product.getDescription(), product.getProvider()};
            model.addRow(row);
        }
    }
